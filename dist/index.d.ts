...
declare const createToaster: (key: string) => ((message: titleT, data?: ExternalToast) => string | number) & {
...
declare const toast: ((message: titleT, data?: ExternalToast) => string | number) & {
    ...
    dismiss: (id?: number | string, key?: string) => string | number;
    loading: (message: titleT | React.ReactNode, data?: ExternalToast) => string | number;
} & {
    getHistory: () => (ToastT | ToastToDismiss)[];
    getToasts: (key?: string) => (ToastT | ToastToDismiss)[];
};

declare function useSonner(key?: string): {
    toasts: ToastT[];
};
